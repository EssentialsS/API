...
public interface SBanManager extends Serializable {
    ...
    default Collection<BanData<?>> banByAll(@NotNull ServerPlayer player, @Nullable LocalDateTime dateTime) throws SocketException {
    ...
    default MacAddressBanData banMacAddress(@NotNull ServerSideConnection player, @Nullable LocalDateTime until) throws SocketException {
