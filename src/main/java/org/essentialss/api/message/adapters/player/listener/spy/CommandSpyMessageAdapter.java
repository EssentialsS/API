...
public interface CommandSpyMessageAdapter extends MessageAdapter {
    ...
    @NotNull
    Component adaptMessage(@NotNull Component messageToAdapt, @NotNull Subject commandSender, @NotNull String command, @NotNull String arguments);

    @NotNull
    default Component adaptMessage(@NotNull Subject subject, @NotNull String command, @NotNull String arguments) {
